...
/**
 * Utility class, containing only methods for calculating {@link CreateNecklace} <i>Necklace</i> instances
 ...
 * {@link WeightUnit}. Method {@link #calculateNecklaceTotalCaratWeight(CreateNecklace)} performs automatic
...
public final class CalculateNecklace {
     ...
     */
    public static BigDecimal calculateNecklaceTotalCost(CreateNecklace necklace) {
     ...
     *
     * @param necklace an instance of <i>Necklace</i>, created by {@link CreateNecklace#CreateNecklace()}
     * @return {@link BigDecimal} total <i>Necklace</i> elements weight value in carats
     */
    public static BigDecimal calculateNecklaceTotalCaratWeight(CreateNecklace necklace) {
